...
| 修改商品信息              | put:localhost:8080/productInfo/updateProduct?pname=一加Ace2pro&price=3999&pinvent=100&punit=台&pnw=288g&pexp=一年有限保修&pintro=一加手机是OPPO的子品牌&pno=104&tno=108&tname=手机&status=1                                                                                                                         | Result对象               | 更新product_info数据库中任意信息（可以更新status），注意pno不能和之前商品的重复，否则会返回错误                                                                                                                                    |
...
| 根据tno返回一条数据         | get:localhost:8080/productInfo/findByTno/108                                                                                                                                                                  | list                   | 返回查询结果|                                                                                                                                                                                        |
|根据pname查询商品不分页|localhost:8080/productInfo/findByPnameNoPage/{pname}|list|根据pname查询商品不分页|
...
| 根据pname模糊查询订单信息 | get:localhost:8080/orderInfo/findByPname?pname=华为                                                                                            | Result对象      | 无   |
